...
voiv_df = fetch_geometries(db, "voivodships")
countries_df = fetch_geometries(db, "countries")
...
#print(voiv_within_countries[['id_left', 'id_right']])

create_edges(db, voiv_within_countries,'voivodships', 'countries', "edges_rel_4")